...
class PointerModel(object):
    ...
    def PointerDecoder(self, decoder_inputs, initial_state, encoder_states, cond, cell, feed_previous=False):
        """
    ...
    def _add_placeholder(self):
        ...
        self.s = tf.placeholder(tf.float32, [None, hps.audio_length, 3], name='audio')
    ...
    def _add_feature_encoder(self, audio_inputs):
        with tf.variable_scope('feature') as scope:
            ...
            dense1 = tf.nn.dropout(dense1, keep_prob=self.kp)
    ...
    def _add_decoder(self, inputs, initial_state, encoder_states, cond, feed_previous=True):
        with tf.variable_scope('decoder') as scope:
            ...
            return self.PointerDecoder(inputs, initial_state, encoder_states, cond, cell, feed_previous)
